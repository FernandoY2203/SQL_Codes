-- Exercicio 2: Or, And e Performance
...
-- 1) Traga os fucionarios que trabalham no departamento de filmes Ou no departamennto de roupas.

-- Vendo a quantidade de funcionarios por departamento, para fazer a selecao com mais performance.
...
-- 2) O gestor de marketing pediu a lista das funcionarias que trabalhem no departamento de filmes Ou no departamento 
-- lar. Ele necessita enviar um email para as colaboradoras desses dois setores.
